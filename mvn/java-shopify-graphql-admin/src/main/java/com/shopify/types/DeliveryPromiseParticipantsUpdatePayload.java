...
public class DeliveryPromiseParticipantsUpdatePayload {
   ...
   */
  private List<PromiseParticipant> promiseParticipants;
   ...
   * The promise participants that were added.
   */
  public List<PromiseParticipant> getPromiseParticipants() {
    return promiseParticipants;
  }

  public void setPromiseParticipants(List<PromiseParticipant> promiseParticipants) {
  ...
  public static class Builder {
     ...
     * The promise participants that were added.
     */
    public Builder promiseParticipants(List<PromiseParticipant> promiseParticipants) {
      this.promiseParticipants = promiseParticipants;
      return this;
    }
