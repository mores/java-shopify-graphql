...
public class FileConnection {
  ...
  public void setEdges(List<FileEdge> edges) {
    this.edges = edges;
  }
  ...
  public String toString() {
    return "FileConnection{edges='" + edges + "', nodes='" + nodes + "', pageInfo='" + pageInfo + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    FileConnection that = (FileConnection) o;
  ...
  public static class Builder {
    ...
    public FileConnection build() {
      FileConnection result = new FileConnection();
     ...
     * The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
     */
    public Builder edges(List<FileEdge> edges) {
      this.edges = edges;
      return this;
    }
     ...
     * of related nodes. At each node, you specify the fields that you want to retrieve.
     */
    public Builder nodes(List<File> nodes) {
      this.nodes = nodes;
      return this;
    }
