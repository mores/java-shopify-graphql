...
public class DeliveryCustomizationConnection {
  ...
  public void setEdges(List<DeliveryCustomizationEdge> edges) {
    this.edges = edges;
  }
  ...
  public void setNodes(List<DeliveryCustomization> nodes) {
    this.nodes = nodes;
  }
  ...
  public String toString() {
    return "DeliveryCustomizationConnection{edges='" + edges + "', nodes='" + nodes + "', pageInfo='" + pageInfo + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    DeliveryCustomizationConnection that = (DeliveryCustomizationConnection) o;
  ...
  public static class Builder {
    ...
    public DeliveryCustomizationConnection build() {
      DeliveryCustomizationConnection result = new DeliveryCustomizationConnection();
     ...
     * The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
     */
    public Builder edges(List<DeliveryCustomizationEdge> edges) {
      this.edges = edges;
      return this;
    }
     ...
     * want to retrieve.
     */
    public Builder nodes(List<DeliveryCustomization> nodes) {
      this.nodes = nodes;
      return this;
    }
