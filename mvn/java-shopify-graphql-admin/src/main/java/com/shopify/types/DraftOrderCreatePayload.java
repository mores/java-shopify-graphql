...
public class DraftOrderCreatePayload {
  ...
  public String toString() {
    return "DraftOrderCreatePayload{draftOrder='" + draftOrder + "', userErrors='" + userErrors + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    DraftOrderCreatePayload that = (DraftOrderCreatePayload) o;
  ...
  public static class Builder {
    ...
    public DraftOrderCreatePayload build() {
      DraftOrderCreatePayload result = new DraftOrderCreatePayload();
