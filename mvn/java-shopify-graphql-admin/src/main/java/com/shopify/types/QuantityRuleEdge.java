...
public class QuantityRuleEdge {
  ...
  public void setNode(QuantityRule node) {
    this.node = node;
  }

  @Override
  public String toString() {
    return "QuantityRuleEdge{cursor='" + cursor + "', node='" + node + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    QuantityRuleEdge that = (QuantityRuleEdge) o;
  ...
  public static class Builder {
    ...
    public QuantityRuleEdge build() {
      QuantityRuleEdge result = new QuantityRuleEdge();
