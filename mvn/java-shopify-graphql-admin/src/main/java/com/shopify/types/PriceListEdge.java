...
public class PriceListEdge {
  ...
  public void setNode(PriceList node) {
    this.node = node;
  }

  @Override
  public String toString() {
    return "PriceListEdge{cursor='" + cursor + "', node='" + node + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    PriceListEdge that = (PriceListEdge) o;
  ...
  public static class Builder {
    ...
    public PriceListEdge build() {
      PriceListEdge result = new PriceListEdge();
