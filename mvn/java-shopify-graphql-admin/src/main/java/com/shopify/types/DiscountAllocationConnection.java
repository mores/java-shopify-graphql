...
public class DiscountAllocationConnection {
  ...
  public void setEdges(List<DiscountAllocationEdge> edges) {
    this.edges = edges;
  }
  ...
  public void setNodes(List<DiscountAllocation> nodes) {
    this.nodes = nodes;
  }
  ...
  public String toString() {
    return "DiscountAllocationConnection{edges='" + edges + "', nodes='" + nodes + "', pageInfo='" + pageInfo + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    DiscountAllocationConnection that = (DiscountAllocationConnection) o;
  ...
  public static class Builder {
    ...
    public DiscountAllocationConnection build() {
      DiscountAllocationConnection result = new DiscountAllocationConnection();
