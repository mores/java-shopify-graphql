...
public class Market implements MetafieldReferencer, com.shopify.types.HasMetafieldDefinitions, com.shopify.types.HasMetafields, com.shopify.types.Node {
  ...
  public String toString() {
    return "Market{catalogs='" + catalogs + "', catalogsCount='" + catalogsCount + "', currencySettings='" + currencySettings + "', enabled='" + enabled + "', handle='" + handle + "', id='" + id + "', metafield='" + metafield + "', metafieldDefinitions='" + metafieldDefinitions + "', metafields='" + metafields + "', name='" + name + "', priceList='" + priceList + "', primary='" + primary + "', regions='" + regions + "', webPresence='" + webPresence + "', webPresences='" + webPresences + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(catalogs, catalogsCount, currencySettings, enabled, handle, id, metafield, metafieldDefinitions, metafields, name, priceList, primary, regions, webPresence, webPresences);
  }
