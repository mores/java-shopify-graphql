...
public class WebhookSubscription implements com.shopify.types.LegacyInteroperability, com.shopify.types.Node {
  ...
  public String toString() {
    return "WebhookSubscription{apiVersion='" + apiVersion + "', callbackUrl='" + callbackUrl + "', createdAt='" + createdAt + "', endpoint='" + endpoint + "', filter='" + filter + "', format='" + format + "', id='" + id + "', includeFields='" + includeFields + "', legacyResourceId='" + legacyResourceId + "', metafieldNamespaces='" + metafieldNamespaces + "', topic='" + topic + "', updatedAt='" + updatedAt + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, callbackUrl, createdAt, endpoint, filter, format, id, includeFields, legacyResourceId, metafieldNamespaces, topic, updatedAt);
  }
