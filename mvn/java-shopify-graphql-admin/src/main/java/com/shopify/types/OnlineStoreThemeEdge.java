...
public class OnlineStoreThemeEdge {
  ...
  public void setNode(OnlineStoreTheme node) {
    this.node = node;
  }

  @Override
  public String toString() {
    return "OnlineStoreThemeEdge{cursor='" + cursor + "', node='" + node + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    OnlineStoreThemeEdge that = (OnlineStoreThemeEdge) o;
  ...
  public static class Builder {
    ...
    public OnlineStoreThemeEdge build() {
      OnlineStoreThemeEdge result = new OnlineStoreThemeEdge();
