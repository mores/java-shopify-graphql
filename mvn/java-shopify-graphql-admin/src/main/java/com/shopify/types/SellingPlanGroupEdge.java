...
public class SellingPlanGroupEdge {
  ...
  public void setNode(SellingPlanGroup node) {
    this.node = node;
  }

  @Override
  public String toString() {
    return "SellingPlanGroupEdge{cursor='" + cursor + "', node='" + node + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    SellingPlanGroupEdge that = (SellingPlanGroupEdge) o;
  ...
  public static class Builder {
    ...
    public SellingPlanGroupEdge build() {
      SellingPlanGroupEdge result = new SellingPlanGroupEdge();
