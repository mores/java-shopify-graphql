...
public class ReturnReopenPayload {
  ...
  public String toString() {
    return "ReturnReopenPayload{return='" + _return + "', userErrors='" + userErrors + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ReturnReopenPayload that = (ReturnReopenPayload) o;
  ...
  public static class Builder {
    ...
    public ReturnReopenPayload build() {
      ReturnReopenPayload result = new ReturnReopenPayload();
