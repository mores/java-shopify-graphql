...
public class SellingPlanGroupAddProductVariantsPayload {
  ...
  public String toString() {
    return "SellingPlanGroupAddProductVariantsPayload{sellingPlanGroup='" + sellingPlanGroup + "', userErrors='" + userErrors + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    SellingPlanGroupAddProductVariantsPayload that = (SellingPlanGroupAddProductVariantsPayload) o;
  ...
  public static class Builder {
    ...
    public SellingPlanGroupAddProductVariantsPayload build() {
      SellingPlanGroupAddProductVariantsPayload result = new SellingPlanGroupAddProductVariantsPayload();
