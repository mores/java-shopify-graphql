...
public class ArticleCreateInput {
  ...
  public String toString() {
    return "ArticleCreateInput{blogId='" + blogId + "', handle='" + handle + "', body='" + body + "', summary='" + summary + "', isPublished='" + isPublished + "', publishDate='" + publishDate + "', templateSuffix='" + templateSuffix + "', metafields='" + metafields + "', tags='" + tags + "', image='" + image + "', title='" + title + "', author='" + author + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ArticleCreateInput that = (ArticleCreateInput) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(blogId, handle, body, summary, isPublished, publishDate, templateSuffix, metafields, tags, image, title, author);
  }
  ...
  public static class Builder {
    ...
    public ArticleCreateInput build() {
      ArticleCreateInput result = new ArticleCreateInput();
