 ...
 */
public class CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection{background='" + background + "', border='" + border + "', borderStyle='" + borderStyle + "', borderWidth='" + borderWidth + "', colors='" + colors + "', cornerRadius='" + cornerRadius + "', padding='" + padding + "', shadow='" + shadow + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection that = (CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection build() {
      CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection result = new CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSection();
