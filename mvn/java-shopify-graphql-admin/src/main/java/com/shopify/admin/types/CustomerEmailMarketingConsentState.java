...
public class CustomerEmailMarketingConsentState {
  ...
  public String toString() {
    return "CustomerEmailMarketingConsentState{consentUpdatedAt='" + consentUpdatedAt + "', marketingOptInLevel='" + marketingOptInLevel + "', marketingState='" + marketingState + "', sourceLocation='" + sourceLocation + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consentUpdatedAt, marketingOptInLevel, marketingState, sourceLocation);
  }
