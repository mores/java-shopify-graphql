...
public class RefundEdge {
  ...
  public void setNode(Refund node) {
    this.node = node;
  }

  @Override
  public String toString() {
    return "RefundEdge{cursor='" + cursor + "', node='" + node + "'}";
  }
  ...
  public static class Builder {
    ...
    public RefundEdge build() {
      RefundEdge result = new RefundEdge();
     ...
     * The item at the end of RefundEdge.
     */
    public Builder node(Refund node) {
      this.node = node;
      return this;
    }
  }
