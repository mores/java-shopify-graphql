 ...
 */
public class CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput{colors='" + colors + "', background='" + background + "', cornerRadius='" + cornerRadius + "', border='" + border + "', borderStyle='" + borderStyle + "', borderWidth='" + borderWidth + "', shadow='" + shadow + "', padding='" + padding + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput that = (CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput build() {
      CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput result = new CheckoutAndAccountsConfigurationBrandingCustomerAccountsMainSectionInput();
