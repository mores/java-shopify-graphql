 ...
 */
public class CheckoutAndAccountsConfigurationBrandingMainSection {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingMainSection() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingMainSection{background='" + background + "', border='" + border + "', borderStyle='" + borderStyle + "', borderWidth='" + borderWidth + "', colors='" + colors + "', cornerRadius='" + cornerRadius + "', padding='" + padding + "', shadow='" + shadow + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingMainSection that = (CheckoutAndAccountsConfigurationBrandingMainSection) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingMainSection build() {
      CheckoutAndAccountsConfigurationBrandingMainSection result = new CheckoutAndAccountsConfigurationBrandingMainSection();
