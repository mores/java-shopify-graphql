...
import com.shopify.admin.types.ContextualPublicationContext;
...
import com.shopify.admin.types.ProductMediaSortKeys;
...
public class ProductByIdentifierProjectionRoot<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public ComponentizedProductsBundleConsolidatedOptionProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> bundleConsolidatedOptions(
      ) {
    ComponentizedProductsBundleConsolidatedOptionProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> projection = new ComponentizedProductsBundleConsolidatedOptionProjection<>(this, this);    
  ...
  public ProductComponentTypeConnectionProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> productComponents(
      ) {
    ProductComponentTypeConnectionProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> projection = new ProductComponentTypeConnectionProjection<>(this, this);    
  ...
  public CountProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> productComponentsCount(
      ) {
    CountProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> projection = new CountProjection<>(this, this);    
  ...
  public ProductConnectionProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> productParents(
      ) {
    ProductConnectionProjection<ProductByIdentifierProjectionRoot<PARENT, ROOT>, ProductByIdentifierProjectionRoot<PARENT, ROOT>> projection = new ProductConnectionProjection<>(this, this);    
