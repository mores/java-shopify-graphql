 ...
 */
public class DiscountTagsGraphQLQuery extends GraphQLQuery {
  public DiscountTagsGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, DiscountTagSortKeys sortKey, String query, String queryName,
  ...
  public DiscountTagsGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    private DiscountTagSortKeys sortKey;

    private String query;

    private String queryName;

    public DiscountTagsGraphQLQuery build() {
      return new DiscountTagsGraphQLQuery(first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(DiscountTagSortKeys sortKey) {
