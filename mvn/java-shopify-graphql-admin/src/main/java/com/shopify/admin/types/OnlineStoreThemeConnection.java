...
public class OnlineStoreThemeConnection {
  ...
  public void setEdges(List<OnlineStoreThemeEdge> edges) {
    this.edges = edges;
  }
  ...
  public void setNodes(List<OnlineStoreTheme> nodes) {
    this.nodes = nodes;
  }
  ...
  public String toString() {
    return "OnlineStoreThemeConnection{edges='" + edges + "', nodes='" + nodes + "', pageInfo='" + pageInfo + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    OnlineStoreThemeConnection that = (OnlineStoreThemeConnection) o;
  ...
  public static class Builder {
    ...
    public OnlineStoreThemeConnection build() {
      OnlineStoreThemeConnection result = new OnlineStoreThemeConnection();
