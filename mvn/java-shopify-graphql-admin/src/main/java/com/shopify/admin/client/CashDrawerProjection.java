...
public class CashDrawerProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  public CashDrawerProjection(PARENT parent, ROOT root) {
    super(parent, root, java.util.Optional.of("CashDrawer"));
  }

  public CashDrawerProjection<PARENT, ROOT> __typename() {
    getFields().put("__typename", null);
    return this;
  }

  public CashActivityConnectionProjection<CashDrawerProjection<PARENT, ROOT>, ROOT> cashActivities(
      ) {
     CashActivityConnectionProjection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new CashActivityConnectionProjection<>(this, getRoot());
  ...
  public LocationProjection<CashDrawerProjection<PARENT, ROOT>, ROOT> location() {
     LocationProjection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new LocationProjection<>(this, getRoot());
     getFields().put("location", projection);
     return projection;
  }

  public MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> netSales() {
     MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new MoneyV2Projection<>(this, getRoot());
  ...
  public PointOfSaleDeviceConnectionProjection<CashDrawerProjection<PARENT, ROOT>, ROOT> pointOfSaleDevices(
      ) {
     PointOfSaleDeviceConnectionProjection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new PointOfSaleDeviceConnectionProjection<>(this, getRoot());
  ...
  public MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> totalAdjustments() {
     MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new MoneyV2Projection<>(this, getRoot());
  ...
  public MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> totalDiscrepancies() {
     MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new MoneyV2Projection<>(this, getRoot());
  ...
  public MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> totalRefunds() {
     MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new MoneyV2Projection<>(this, getRoot());
  ...
  public MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> totalSales() {
     MoneyV2Projection<CashDrawerProjection<PARENT, ROOT>, ROOT> projection = new MoneyV2Projection<>(this, getRoot());
  ...
  public CashDrawerProjection<PARENT, ROOT> id() {
    getFields().put("id", null);
    return this;
  }

  public CashDrawerProjection<PARENT, ROOT> name() {
