...
public class NodeProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public ConsentPolicyFragmentProjection<NodeProjection<PARENT, ROOT>, ROOT> onConsentPolicy() {
    ConsentPolicyFragmentProjection<NodeProjection<PARENT, ROOT>, ROOT> fragment = new ConsentPolicyFragmentProjection<>(this, getRoot());
    getFragments().add(fragment);
    return fragment;
  }
  ...
  public DeliveryPromiseParticipantFragmentProjection<NodeProjection<PARENT, ROOT>, ROOT> onDeliveryPromiseParticipant(
      ) {
    DeliveryPromiseParticipantFragmentProjection<NodeProjection<PARENT, ROOT>, ROOT> fragment = new DeliveryPromiseParticipantFragmentProjection<>(this, getRoot());
    getFragments().add(fragment);
    return fragment;
  }
