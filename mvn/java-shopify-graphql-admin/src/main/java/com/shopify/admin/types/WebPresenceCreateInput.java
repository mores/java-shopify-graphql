 ...
 */
public class WebPresenceCreateInput {
  /**
  ...
  public String toString() {
    return "WebPresenceCreateInput{domainId='" + domainId + "', defaultLocale='" + defaultLocale + "', alternateLocales='" + alternateLocales + "', subfolderSuffix='" + subfolderSuffix + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    WebPresenceCreateInput that = (WebPresenceCreateInput) o;
  ...
  public static class Builder {
    ...
    public WebPresenceCreateInput build() {
      WebPresenceCreateInput result = new WebPresenceCreateInput();
