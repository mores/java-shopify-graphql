...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = CashDrawer.class, name = "CashDrawer"),
    ...
    @JsonSubTypes.Type(value = DeliveryPromiseParticipant.class, name = "DeliveryPromiseParticipant"),
    ...
    @JsonSubTypes.Type(value = OrderEditSession.class, name = "OrderEditSession"),
    ...
    @JsonSubTypes.Type(value = PointOfSaleDevicePaymentSession.class, name = "PointOfSaleDevicePaymentSession"),
    ...
    @JsonSubTypes.Type(value = ReturnReasonDefinition.class, name = "ReturnReasonDefinition"),
