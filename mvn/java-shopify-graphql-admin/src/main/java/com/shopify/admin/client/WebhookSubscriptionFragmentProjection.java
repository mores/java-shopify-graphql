...
public class WebhookSubscriptionFragmentProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public WebhookSubscriptionMetafieldIdentifierProjection<WebhookSubscriptionFragmentProjection<PARENT, ROOT>, ROOT> metafields(
      ) {
     WebhookSubscriptionMetafieldIdentifierProjection<WebhookSubscriptionFragmentProjection<PARENT, ROOT>, ROOT> projection = new WebhookSubscriptionMetafieldIdentifierProjection<>(this, getRoot());
