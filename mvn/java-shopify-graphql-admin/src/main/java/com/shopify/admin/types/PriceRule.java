...
public class PriceRule implements com.shopify.admin.types.CommentEventSubject, com.shopify.admin.types.HasEvents, com.shopify.admin.types.LegacyInteroperability, com.shopify.admin.types.Node {
  /**
