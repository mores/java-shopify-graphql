...
import com.shopify.admin.types.BalanceTransactionSortKeys;
import com.shopify.admin.types.PayoutSortKeys;
import com.shopify.admin.types.ShopifyPaymentsPayoutTransactionType;
...
public class ShopifyPaymentsAccountProjectionRoot<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public ShopifyPaymentsAccountProjectionRoot<PARENT, ROOT> accountOpenerName() {
