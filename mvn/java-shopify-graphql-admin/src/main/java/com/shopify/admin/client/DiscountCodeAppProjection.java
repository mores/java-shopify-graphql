...
public class DiscountCodeAppProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public CountProjection<DiscountCodeAppProjection<PARENT, ROOT>, ROOT> codesCount() {
     CountProjection<DiscountCodeAppProjection<PARENT, ROOT>, ROOT> projection = new CountProjection<>(this, getRoot());
  ...
  public DiscountContextProjection<DiscountCodeAppProjection<PARENT, ROOT>, ROOT> context() {
     DiscountContextProjection<DiscountCodeAppProjection<PARENT, ROOT>, ROOT> projection = new DiscountContextProjection<>(this, getRoot());
  ...
  public DiscountClassProjection<DiscountCodeAppProjection<PARENT, ROOT>, ROOT> discountClasses() {
     DiscountClassProjection<DiscountCodeAppProjection<PARENT, ROOT>, ROOT> projection = new DiscountClassProjection<>(this, getRoot());
  ...
  public DiscountCodeAppProjection<PARENT, ROOT> appliesOnOneTimePurchase() {
    getFields().put("appliesOnOneTimePurchase", null);
    return this;
  }

  public DiscountCodeAppProjection<PARENT, ROOT> appliesOnSubscription() {
  ...
  public DiscountCodeAppProjection<PARENT, ROOT> tags() {
