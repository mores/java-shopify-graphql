 ...
 */
public class CheckoutAndAccountsConfigurationBrandingHeader {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingHeader() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingHeader{alignment='" + alignment + "', background='" + background + "', colors='" + colors + "', divided='" + divided + "', logo='" + logo + "', padding='" + padding + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingHeader that = (CheckoutAndAccountsConfigurationBrandingHeader) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alignment, background, colors, divided, logo, padding);
  }
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingHeader build() {
      CheckoutAndAccountsConfigurationBrandingHeader result = new CheckoutAndAccountsConfigurationBrandingHeader();
