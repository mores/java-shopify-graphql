...
public class SegmentStringFilter implements com.shopify.admin.types.SegmentFilter {
  /**
  ...
  public String toString() {
    return "SegmentStringFilter{localizedName='" + localizedName + "', multiValue='" + multiValue + "', queryName='" + queryName + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    SegmentStringFilter that = (SegmentStringFilter) o;
  ...
  public static class Builder {
    ...
    public SegmentStringFilter build() {
      SegmentStringFilter result = new SegmentStringFilter();
