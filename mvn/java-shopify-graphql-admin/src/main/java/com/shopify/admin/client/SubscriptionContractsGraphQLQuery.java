...
public class SubscriptionContractsGraphQLQuery extends GraphQLQuery {
  public SubscriptionContractsGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, SubscriptionContractsSortKeys sortKey, String query, String queryName,
  ...
  public SubscriptionContractsGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    private SubscriptionContractsSortKeys sortKey;

    private String query;

    private String queryName;

    public SubscriptionContractsGraphQLQuery build() {
      return new SubscriptionContractsGraphQLQuery(first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(SubscriptionContractsSortKeys sortKey) {
