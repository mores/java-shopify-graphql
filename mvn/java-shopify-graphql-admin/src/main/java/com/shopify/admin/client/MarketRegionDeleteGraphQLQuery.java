...
public class MarketRegionDeleteGraphQLQuery extends GraphQLQuery {
  ...
  public MarketRegionDeleteGraphQLQuery() {
    super("mutation");
  }

  @Override
  public String getOperationName() {
    return "marketRegionDelete";
  }
  ...
  public static class Builder {
    ...
    public MarketRegionDeleteGraphQLQuery build() {
      return new MarketRegionDeleteGraphQLQuery(id, queryName, fieldsSet);
