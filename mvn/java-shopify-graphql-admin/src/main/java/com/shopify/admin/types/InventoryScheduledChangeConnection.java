...
public class InventoryScheduledChangeConnection {
  ...
  public void setEdges(List<InventoryScheduledChangeEdge> edges) {
    this.edges = edges;
  }
  ...
  public void setNodes(List<InventoryScheduledChange> nodes) {
    this.nodes = nodes;
  }
  ...
  public String toString() {
    return "InventoryScheduledChangeConnection{edges='" + edges + "', nodes='" + nodes + "', pageInfo='" + pageInfo + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    InventoryScheduledChangeConnection that = (InventoryScheduledChangeConnection) o;
  ...
  public static class Builder {
    ...
    public InventoryScheduledChangeConnection build() {
      InventoryScheduledChangeConnection result = new InventoryScheduledChangeConnection();
