 ...
 */
public class CheckoutAndAccountsConfigurationBrandingLogo {
  /**
   * The logo image.
   */
  ...
  public CheckoutAndAccountsConfigurationBrandingLogo() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingLogo{image='" + image + "', maxWidth='" + maxWidth + "', visibility='" + visibility + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingLogo that = (CheckoutAndAccountsConfigurationBrandingLogo) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingLogo build() {
      CheckoutAndAccountsConfigurationBrandingLogo result = new CheckoutAndAccountsConfigurationBrandingLogo();
