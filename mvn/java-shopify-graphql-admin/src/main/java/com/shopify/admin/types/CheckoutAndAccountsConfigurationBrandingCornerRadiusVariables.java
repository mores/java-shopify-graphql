 ...
 */
public class CheckoutAndAccountsConfigurationBrandingCornerRadiusVariables {
  /**
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingCornerRadiusVariables{base='" + base + "', large='" + large + "', small='" + small + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingCornerRadiusVariables that = (CheckoutAndAccountsConfigurationBrandingCornerRadiusVariables) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingCornerRadiusVariables build() {
      CheckoutAndAccountsConfigurationBrandingCornerRadiusVariables result = new CheckoutAndAccountsConfigurationBrandingCornerRadiusVariables();
