...
public class OrderCreateLineItemInput {
  ...
  public String toString() {
    return "OrderCreateLineItemInput{fulfillmentService='" + fulfillmentService + "', giftCard='" + giftCard + "', priceSet='" + priceSet + "', productId='" + productId + "', properties='" + properties + "', quantity='" + quantity + "', requiresShipping='" + requiresShipping + "', sku='" + sku + "', taxLines='" + taxLines + "', taxable='" + taxable + "', title='" + title + "', variantId='" + variantId + "', variantTitle='" + variantTitle + "', vendor='" + vendor + "', weight='" + weight + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fulfillmentService, giftCard, priceSet, productId, properties, quantity, requiresShipping, sku, taxLines, taxable, title, variantId, variantTitle, vendor, weight);
  }
