...
public class CustomerSmsMarketingConsentStateProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public LocationProjection<CustomerSmsMarketingConsentStateProjection<PARENT, ROOT>, ROOT> sourceLocation(
      ) {
     LocationProjection<CustomerSmsMarketingConsentStateProjection<PARENT, ROOT>, ROOT> projection = new LocationProjection<>(this, getRoot());
