...
public class DraftOrderLineItemInput {
   ...
   */
  private List<DraftOrderLineItemComponentInput> components;
  ...
  public void setComponents(List<DraftOrderLineItemComponentInput> components) {
  ...
  public String toString() {
    return "DraftOrderLineItemInput{appliedDiscount='" + appliedDiscount + "', customAttributes='" + customAttributes + "', originalUnitPriceWithCurrency='" + originalUnitPriceWithCurrency + "', quantity='" + quantity + "', requiresShipping='" + requiresShipping + "', sku='" + sku + "', taxable='" + taxable + "', title='" + title + "', variantId='" + variantId + "', weight='" + weight + "', uuid='" + uuid + "', components='" + components + "', generatePriceOverride='" + generatePriceOverride + "', priceOverride='" + priceOverride + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appliedDiscount, customAttributes, originalUnitPriceWithCurrency, quantity, requiresShipping, sku, taxable, title, variantId, weight, uuid, components, generatePriceOverride, priceOverride);
  }
  ...
  public static class Builder {
     ...
     * The components of the draft order line item.
     */
    public Builder components(List<DraftOrderLineItemComponentInput> components) {
      this.components = components;
      return this;
    }
