...
public class CalculatedManualDiscountApplication implements com.shopify.admin.types.CalculatedDiscountApplication {
  /**
  ...
  public String toString() {
    return "CalculatedManualDiscountApplication{allocationMethod='" + allocationMethod + "', appliedTo='" + appliedTo + "', description='" + description + "', id='" + id + "', targetSelection='" + targetSelection + "', targetType='" + targetType + "', value='" + value + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CalculatedManualDiscountApplication that = (CalculatedManualDiscountApplication) o;
  ...
  public static class Builder {
    ...
    public CalculatedManualDiscountApplication build() {
      CalculatedManualDiscountApplication result = new CalculatedManualDiscountApplication();
