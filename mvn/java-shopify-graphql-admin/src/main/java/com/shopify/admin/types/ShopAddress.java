...
public class ShopAddress implements com.shopify.admin.types.Node {
  /**
  ...
  public String toString() {
    return "ShopAddress{address1='" + address1 + "', address2='" + address2 + "', city='" + city + "', company='" + company + "', coordinatesValidated='" + coordinatesValidated + "', country='" + country + "', countryCode='" + countryCode + "', countryCodeV2='" + countryCodeV2 + "', firstName='" + firstName + "', formatted='" + formatted + "', formattedArea='" + formattedArea + "', id='" + id + "', lastName='" + lastName + "', latitude='" + latitude + "', longitude='" + longitude + "', name='" + name + "', phone='" + phone + "', province='" + province + "', provinceCode='" + provinceCode + "', zip='" + zip + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address1, address2, city, company, coordinatesValidated, country, countryCode, countryCodeV2, firstName, formatted, formattedArea, id, lastName, latitude, longitude, name, phone, province, provinceCode, zip);
  }
