...
public class TipSale implements com.shopify.admin.types.Sale {
  /**
  ...
  public String toString() {
    return "TipSale{actionType='" + actionType + "', id='" + id + "', lineItem='" + lineItem + "', lineType='" + lineType + "', quantity='" + quantity + "', taxes='" + taxes + "', totalAmount='" + totalAmount + "', totalDiscountAmountAfterTaxes='" + totalDiscountAmountAfterTaxes + "', totalDiscountAmountBeforeTaxes='" + totalDiscountAmountBeforeTaxes + "', totalTaxAmount='" + totalTaxAmount + "'}";
  }
