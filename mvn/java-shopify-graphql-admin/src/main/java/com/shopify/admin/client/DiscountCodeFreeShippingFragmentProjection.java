...
public class DiscountCodeFreeShippingFragmentProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public DiscountClassProjection<DiscountCodeFreeShippingFragmentProjection<PARENT, ROOT>, ROOT> discountClasses(
      ) {
     DiscountClassProjection<DiscountCodeFreeShippingFragmentProjection<PARENT, ROOT>, ROOT> projection = new DiscountClassProjection<>(this, getRoot());
  ...
  public DiscountCodeFreeShippingFragmentProjection<PARENT, ROOT> tags() {
