...
public class ShopFeatures {
   ...
   */
  private boolean unifiedMarkets;
  ...
  public void setUnifiedMarkets(boolean unifiedMarkets) {
    this.unifiedMarkets = unifiedMarkets;
  }
  ...
  public static class Builder {
    ...
    public ShopFeatures build() {
      ...
      result.unifiedMarkets = this.unifiedMarkets;
     ...
     * Whether a shop is eligible for Unified Markets.
     */
    public Builder unifiedMarkets(boolean unifiedMarkets) {
      this.unifiedMarkets = unifiedMarkets;
      return this;
    }
