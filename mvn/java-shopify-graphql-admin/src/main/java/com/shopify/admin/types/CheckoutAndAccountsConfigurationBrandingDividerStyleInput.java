 ...
 */
public class CheckoutAndAccountsConfigurationBrandingDividerStyleInput {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingDividerStyleInput() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingDividerStyleInput{borderStyle='" + borderStyle + "', borderWidth='" + borderWidth + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingDividerStyleInput that = (CheckoutAndAccountsConfigurationBrandingDividerStyleInput) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingDividerStyleInput build() {
      CheckoutAndAccountsConfigurationBrandingDividerStyleInput result = new CheckoutAndAccountsConfigurationBrandingDividerStyleInput();
