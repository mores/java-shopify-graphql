...
public class WebhookSubscriptionProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public WebhookSubscriptionMetafieldIdentifierProjection<WebhookSubscriptionProjection<PARENT, ROOT>, ROOT> metafields(
      ) {
     WebhookSubscriptionMetafieldIdentifierProjection<WebhookSubscriptionProjection<PARENT, ROOT>, ROOT> projection = new WebhookSubscriptionMetafieldIdentifierProjection<>(this, getRoot());
  ...
  public WebhookSubscriptionProjection<PARENT, ROOT> filter() {
  ...
  public WebhookSubscriptionProjection<PARENT, ROOT> name() {
