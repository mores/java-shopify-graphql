...
public class AppDiscountType {
  ...
  public String toString() {
    return "AppDiscountType{app='" + app + "', appBridge='" + appBridge + "', appKey='" + appKey + "', description='" + description + "', discountClass='" + discountClass + "', discountClasses='" + discountClasses + "', functionId='" + functionId + "', targetType='" + targetType + "', title='" + title + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(app, appBridge, appKey, description, discountClass, discountClasses, functionId, targetType, title);
  }
