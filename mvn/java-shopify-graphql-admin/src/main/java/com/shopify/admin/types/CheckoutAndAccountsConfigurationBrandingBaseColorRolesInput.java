 ...
 */
public class CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput{background='" + background + "', text='" + text + "', border='" + border + "', icon='" + icon + "', accent='" + accent + "', decorative='" + decorative + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput that = (CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput build() {
      CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput result = new CheckoutAndAccountsConfigurationBrandingBaseColorRolesInput();
