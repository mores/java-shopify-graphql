...
public class MarketsGraphQLQuery extends GraphQLQuery {
  public MarketsGraphQLQuery(MarketType type, Integer first, String after, Integer last,
      String before, Boolean reverse, MarketsSortKeys sortKey, String query, String queryName,
  ...
  public static class Builder {
    ...
    private MarketsSortKeys sortKey;

    private String query;

    private String queryName;

    public MarketsGraphQLQuery build() {
      return new MarketsGraphQLQuery(type, first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(MarketsSortKeys sortKey) {
