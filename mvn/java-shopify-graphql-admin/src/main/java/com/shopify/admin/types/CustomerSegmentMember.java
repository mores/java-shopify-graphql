...
public class CustomerSegmentMember implements com.shopify.admin.types.HasMetafields {
  /**
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amountSpent, defaultAddress, defaultEmailAddress, defaultPhoneNumber, displayName, firstName, id, lastName, lastOrderId, mergeable, metafield, metafields, note, numberOfOrders);
  }
