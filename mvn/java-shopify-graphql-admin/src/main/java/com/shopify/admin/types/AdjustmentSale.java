...
public class AdjustmentSale implements com.shopify.admin.types.Sale {
  /**
  ...
  public String toString() {
    return "AdjustmentSale{actionType='" + actionType + "', id='" + id + "', lineType='" + lineType + "', quantity='" + quantity + "', taxes='" + taxes + "', totalAmount='" + totalAmount + "', totalDiscountAmountAfterTaxes='" + totalDiscountAmountAfterTaxes + "', totalDiscountAmountBeforeTaxes='" + totalDiscountAmountBeforeTaxes + "', totalTaxAmount='" + totalTaxAmount + "'}";
  }
  ...
  public static class Builder {
    ...
    public AdjustmentSale build() {
      AdjustmentSale result = new AdjustmentSale();
