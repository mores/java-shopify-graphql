...
public class DiscountAutomaticBasicFragmentProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public DiscountClassProjection<DiscountAutomaticBasicFragmentProjection<PARENT, ROOT>, ROOT> discountClasses(
      ) {
     DiscountClassProjection<DiscountAutomaticBasicFragmentProjection<PARENT, ROOT>, ROOT> projection = new DiscountClassProjection<>(this, getRoot());
  ...
  public DiscountAutomaticBasicFragmentProjection<PARENT, ROOT> tags() {
