...
public class UnknownSale implements com.shopify.admin.types.Sale {
  /**
  ...
  public String toString() {
    return "UnknownSale{actionType='" + actionType + "', id='" + id + "', lineType='" + lineType + "', quantity='" + quantity + "', taxes='" + taxes + "', totalAmount='" + totalAmount + "', totalDiscountAmountAfterTaxes='" + totalDiscountAmountAfterTaxes + "', totalDiscountAmountBeforeTaxes='" + totalDiscountAmountBeforeTaxes + "', totalTaxAmount='" + totalTaxAmount + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    UnknownSale that = (UnknownSale) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionType, id, lineType, quantity, taxes, totalAmount, totalDiscountAmountAfterTaxes, totalDiscountAmountBeforeTaxes, totalTaxAmount);
  }
  ...
  public static class Builder {
    ...
    public UnknownSale build() {
      UnknownSale result = new UnknownSale();
