 ...
 */
public class CheckoutAndAccountsConfigurationBrandingColorRoles {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingColorRoles() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingColorRoles{accent='" + accent + "', background='" + background + "', border='" + border + "', decorative='" + decorative + "', icon='" + icon + "', text='" + text + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingColorRoles that = (CheckoutAndAccountsConfigurationBrandingColorRoles) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingColorRoles build() {
      CheckoutAndAccountsConfigurationBrandingColorRoles result = new CheckoutAndAccountsConfigurationBrandingColorRoles();
