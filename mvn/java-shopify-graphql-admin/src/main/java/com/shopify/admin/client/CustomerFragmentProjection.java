...
public class CustomerFragmentProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public CustomerEmailAddressProjection<CustomerFragmentProjection<PARENT, ROOT>, ROOT> defaultEmailAddress(
      ) {
     CustomerEmailAddressProjection<CustomerFragmentProjection<PARENT, ROOT>, ROOT> projection = new CustomerEmailAddressProjection<>(this, getRoot());
     getFields().put("defaultEmailAddress", projection);
     return projection;
  }

  public CustomerPhoneNumberProjection<CustomerFragmentProjection<PARENT, ROOT>, ROOT> defaultPhoneNumber(
      ) {
     CustomerPhoneNumberProjection<CustomerFragmentProjection<PARENT, ROOT>, ROOT> projection = new CustomerPhoneNumberProjection<>(this, getRoot());
