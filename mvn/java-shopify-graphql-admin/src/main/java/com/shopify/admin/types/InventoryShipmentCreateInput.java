...
public class InventoryShipmentCreateInput {
  ...
  public String toString() {
    return "InventoryShipmentCreateInput{movementId='" + movementId + "', trackingInput='" + trackingInput + "', lineItems='" + lineItems + "', dateCreated='" + dateCreated + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(movementId, trackingInput, lineItems, dateCreated);
  }
