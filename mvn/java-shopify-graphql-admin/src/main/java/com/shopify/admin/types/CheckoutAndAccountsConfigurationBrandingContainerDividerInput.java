 ...
 */
public class CheckoutAndAccountsConfigurationBrandingContainerDividerInput {
  /**
   * The divider style.
   */
  ...
  public CheckoutAndAccountsConfigurationBrandingContainerDividerInput() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingContainerDividerInput{borderStyle='" + borderStyle + "', borderWidth='" + borderWidth + "', visibility='" + visibility + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingContainerDividerInput that = (CheckoutAndAccountsConfigurationBrandingContainerDividerInput) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingContainerDividerInput build() {
      CheckoutAndAccountsConfigurationBrandingContainerDividerInput result = new CheckoutAndAccountsConfigurationBrandingContainerDividerInput();
