...
import com.shopify.admin.types.SearchResultType;
import com.shopify.admin.types.ShopTagSort;
...
public class ShopFragmentProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public EntitlementsTypeProjection<ShopFragmentProjection<PARENT, ROOT>, ROOT> entitlements() {
     EntitlementsTypeProjection<ShopFragmentProjection<PARENT, ROOT>, ROOT> projection = new EntitlementsTypeProjection<>(this, getRoot());
     getFields().put("entitlements", projection);
     return projection;
  }
  ...
  public MetafieldDefinitionConnectionProjection<ShopFragmentProjection<PARENT, ROOT>, ROOT> metafieldDefinitions(
      ) {
     MetafieldDefinitionConnectionProjection<ShopFragmentProjection<PARENT, ROOT>, ROOT> projection = new MetafieldDefinitionConnectionProjection<>(this, getRoot());
