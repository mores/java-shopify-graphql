...
public class QuantityPricingByVariantUpdateInput {
   ...
   */
  private List<String> quantityPriceBreaksToDeleteByVariantId;
   ...
   * A list of product variant IDs that identify which quantity breaks to remove.
   */
  public List<String> getQuantityPriceBreaksToDeleteByVariantId() {
    return quantityPriceBreaksToDeleteByVariantId;
  }

  public void setQuantityPriceBreaksToDeleteByVariantId(
      List<String> quantityPriceBreaksToDeleteByVariantId) {
  ...
  public String toString() {
    return "QuantityPricingByVariantUpdateInput{quantityPriceBreaksToAdd='" + quantityPriceBreaksToAdd + "', quantityPriceBreaksToDelete='" + quantityPriceBreaksToDelete + "', quantityPriceBreaksToDeleteByVariantId='" + quantityPriceBreaksToDeleteByVariantId + "', quantityRulesToAdd='" + quantityRulesToAdd + "', quantityRulesToDeleteByVariantId='" + quantityRulesToDeleteByVariantId + "', pricesToAdd='" + pricesToAdd + "', pricesToDeleteByVariantId='" + pricesToDeleteByVariantId + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(quantityPriceBreaksToAdd, that.quantityPriceBreaksToAdd) &&
        ...
        Objects.equals(quantityPriceBreaksToDeleteByVariantId, that.quantityPriceBreaksToDeleteByVariantId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quantityPriceBreaksToAdd, quantityPriceBreaksToDelete, quantityPriceBreaksToDeleteByVariantId, quantityRulesToAdd, quantityRulesToDeleteByVariantId, pricesToAdd, pricesToDeleteByVariantId);
  }
  ...
  public static class Builder {
    ...
    public QuantityPricingByVariantUpdateInput build() {
      ...
      result.quantityPriceBreaksToDeleteByVariantId = this.quantityPriceBreaksToDeleteByVariantId;
     ...
     * A list of product variant IDs that identify which quantity breaks to remove.
     */
    public Builder quantityPriceBreaksToDeleteByVariantId(
        List<String> quantityPriceBreaksToDeleteByVariantId) {
      this.quantityPriceBreaksToDeleteByVariantId = quantityPriceBreaksToDeleteByVariantId;
      return this;
    }
