...
public class ExchangeV2 implements com.shopify.admin.types.Node {
  /**
  ...
  public String toString() {
    return "ExchangeV2{additions='" + additions + "', completedAt='" + completedAt + "', createdAt='" + createdAt + "', id='" + id + "', location='" + location + "', mirrored='" + mirrored + "', note='" + note + "', refunds='" + refunds + "', returns='" + returns + "', staffMember='" + staffMember + "', totalAmountProcessedSet='" + totalAmountProcessedSet + "', totalPriceSet='" + totalPriceSet + "', transactions='" + transactions + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additions, completedAt, createdAt, id, location, mirrored, note, refunds, returns, staffMember, totalAmountProcessedSet, totalPriceSet, transactions);
  }
