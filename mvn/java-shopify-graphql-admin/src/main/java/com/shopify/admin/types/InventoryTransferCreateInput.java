 ...
 */
public class InventoryTransferCreateInput {
  /**
  ...
  public InventoryTransferCreateInput() {
  }
  ...
  public String toString() {
    return "InventoryTransferCreateInput{originLocationId='" + originLocationId + "', destinationLocationId='" + destinationLocationId + "', lineItems='" + lineItems + "', dateCreated='" + dateCreated + "', note='" + note + "', tags='" + tags + "', referenceName='" + referenceName + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    InventoryTransferCreateInput that = (InventoryTransferCreateInput) o;
  ...
  public static class Builder {
    ...
    public InventoryTransferCreateInput build() {
      InventoryTransferCreateInput result = new InventoryTransferCreateInput();
