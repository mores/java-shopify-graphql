 ...
 */
public class CheckoutAndAccountsConfigurationBrandingBaseColorRoles {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingBaseColorRoles() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingBaseColorRoles{accent='" + accent + "', background='" + background + "', border='" + border + "', decorative='" + decorative + "', icon='" + icon + "', text='" + text + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingBaseColorRoles that = (CheckoutAndAccountsConfigurationBrandingBaseColorRoles) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingBaseColorRoles build() {
      CheckoutAndAccountsConfigurationBrandingBaseColorRoles result = new CheckoutAndAccountsConfigurationBrandingBaseColorRoles();
