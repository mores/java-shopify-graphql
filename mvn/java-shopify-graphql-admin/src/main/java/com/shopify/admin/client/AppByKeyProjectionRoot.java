...
public class AppByKeyProjectionRoot<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public ChannelConnectionProjection<AppByKeyProjectionRoot<PARENT, ROOT>, AppByKeyProjectionRoot<PARENT, ROOT>> channels(
      ) {
    ChannelConnectionProjection<AppByKeyProjectionRoot<PARENT, ROOT>, AppByKeyProjectionRoot<PARENT, ROOT>> projection = new ChannelConnectionProjection<>(this, this);    
