...
public class SubscriptionContractExpirePayload {
  ...
  public String toString() {
    return "SubscriptionContractExpirePayload{contract='" + contract + "', userErrors='" + userErrors + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionContractExpirePayload that = (SubscriptionContractExpirePayload) o;
  ...
  public static class Builder {
    ...
    public SubscriptionContractExpirePayload build() {
      SubscriptionContractExpirePayload result = new SubscriptionContractExpirePayload();
