...
public class SalesAgreementEdge {
  ...
  public void setNode(SalesAgreement node) {
    this.node = node;
  }

  @Override
  public String toString() {
    return "SalesAgreementEdge{cursor='" + cursor + "', node='" + node + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    SalesAgreementEdge that = (SalesAgreementEdge) o;
  ...
  public static class Builder {
    ...
    public SalesAgreementEdge build() {
      SalesAgreementEdge result = new SalesAgreementEdge();
