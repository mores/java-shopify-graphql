...
public class GiftCardDebitTransaction implements com.shopify.admin.types.GiftCardTransaction, com.shopify.admin.types.HasMetafields, com.shopify.admin.types.Node {
  /**
