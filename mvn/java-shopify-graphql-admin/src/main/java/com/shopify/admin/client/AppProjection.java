...
public class AppProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public ChannelConnectionProjection<AppProjection<PARENT, ROOT>, ROOT> channels() {
     ChannelConnectionProjection<AppProjection<PARENT, ROOT>, ROOT> projection = new ChannelConnectionProjection<>(this, getRoot());
     getFields().put("channels", projection);
     return projection;
  }

  public ChannelConnectionProjection<AppProjection<PARENT, ROOT>, ROOT> channels(Integer first,
