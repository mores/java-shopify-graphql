...
public class WebhookSubscriptionProjectionRoot<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public WebhookSubscriptionMetafieldIdentifierProjection<WebhookSubscriptionProjectionRoot<PARENT, ROOT>, WebhookSubscriptionProjectionRoot<PARENT, ROOT>> metafields(
      ) {
    WebhookSubscriptionMetafieldIdentifierProjection<WebhookSubscriptionProjectionRoot<PARENT, ROOT>, WebhookSubscriptionProjectionRoot<PARENT, ROOT>> projection = new WebhookSubscriptionMetafieldIdentifierProjection<>(this, this);    
  ...
  public WebhookSubscriptionProjectionRoot<PARENT, ROOT> name() {
  ...
  public WebhookSubscriptionProjectionRoot<PARENT, ROOT> uri() {
