...
public class MetafieldConnection {
  ...
  public void setNodes(List<Metafield> nodes) {
    this.nodes = nodes;
  }
  ...
  public String toString() {
    return "MetafieldConnection{edges='" + edges + "', nodes='" + nodes + "', pageInfo='" + pageInfo + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    MetafieldConnection that = (MetafieldConnection) o;
  ...
  public static class Builder {
    ...
    public MetafieldConnection build() {
      MetafieldConnection result = new MetafieldConnection();
     ...
     * The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
     */
    public Builder edges(List<MetafieldEdge> edges) {
      this.edges = edges;
      return this;
    }
     ...
     * want to retrieve.
     */
    public Builder nodes(List<Metafield> nodes) {
      this.nodes = nodes;
      return this;
    }
