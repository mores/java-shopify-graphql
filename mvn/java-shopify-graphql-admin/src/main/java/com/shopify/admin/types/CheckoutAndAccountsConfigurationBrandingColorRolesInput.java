 ...
 */
public class CheckoutAndAccountsConfigurationBrandingColorRolesInput {
  /**
  ...
  public CheckoutAndAccountsConfigurationBrandingColorRolesInput() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingColorRolesInput{background='" + background + "', text='" + text + "', border='" + border + "', icon='" + icon + "', accent='" + accent + "', decorative='" + decorative + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingColorRolesInput that = (CheckoutAndAccountsConfigurationBrandingColorRolesInput) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingColorRolesInput build() {
      CheckoutAndAccountsConfigurationBrandingColorRolesInput result = new CheckoutAndAccountsConfigurationBrandingColorRolesInput();
