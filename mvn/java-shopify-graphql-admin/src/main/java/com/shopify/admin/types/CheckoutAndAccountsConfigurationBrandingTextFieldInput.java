 ...
 */
public class CheckoutAndAccountsConfigurationBrandingTextFieldInput {
  /**
   * The border.
   */
  ...
  public CheckoutAndAccountsConfigurationBrandingTextFieldInput() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingTextFieldInput{border='" + border + "', typography='" + typography + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingTextFieldInput that = (CheckoutAndAccountsConfigurationBrandingTextFieldInput) o;
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingTextFieldInput build() {
      CheckoutAndAccountsConfigurationBrandingTextFieldInput result = new CheckoutAndAccountsConfigurationBrandingTextFieldInput();
