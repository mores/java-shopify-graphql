...
public class MetafieldDefinitionUpdateUserError implements com.shopify.admin.types.DisplayableError {
  /**
   * The error code.
   */
  ...
  public String toString() {
    return "MetafieldDefinitionUpdateUserError{code='" + code + "', elementIndex='" + elementIndex + "', elementKey='" + elementKey + "', field='" + field + "', message='" + message + "'}";
  }
