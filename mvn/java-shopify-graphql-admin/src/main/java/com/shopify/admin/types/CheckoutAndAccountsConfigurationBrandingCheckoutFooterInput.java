 ...
 */
public class CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput {
  /**
   * The divided setting.
   */
  ...
  public CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput() {
  }
  ...
  public String toString() {
    return "CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput{divided='" + divided + "', alignment='" + alignment + "', content='" + content + "', colors='" + colors + "', background='" + background + "', padding='" + padding + "', position='" + position + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput that = (CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(divided, alignment, content, colors, background, padding, position);
  }
  ...
  public static class Builder {
    ...
    public CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput build() {
      CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput result = new CheckoutAndAccountsConfigurationBrandingCheckoutFooterInput();
