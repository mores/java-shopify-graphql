...
public class SellingPlan implements com.shopify.admin.types.HasMetafieldDefinitions, com.shopify.admin.types.HasMetafields, com.shopify.admin.types.HasPublishedTranslations, com.shopify.admin.types.Node {
  /**
  ...
  public String toString() {
    return "SellingPlan{billingPolicy='" + billingPolicy + "', category='" + category + "', createdAt='" + createdAt + "', deliveryPolicy='" + deliveryPolicy + "', description='" + description + "', id='" + id + "', inventoryPolicy='" + inventoryPolicy + "', metafield='" + metafield + "', metafieldDefinitions='" + metafieldDefinitions + "', metafields='" + metafields + "', name='" + name + "', options='" + options + "', position='" + position + "', pricingPolicies='" + pricingPolicies + "', translations='" + translations + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingPolicy, category, createdAt, deliveryPolicy, description, id, inventoryPolicy, metafield, metafieldDefinitions, metafields, name, options, position, pricingPolicies, translations);
  }
