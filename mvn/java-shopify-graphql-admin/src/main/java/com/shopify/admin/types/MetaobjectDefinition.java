...
public class MetaobjectDefinition implements com.shopify.admin.types.Node {
  /**
   ...
   */
  private StandardMetaobjectDefinitionTemplate standardTemplate;
  ...
  public void setStandardTemplate(StandardMetaobjectDefinitionTemplate standardTemplate) {
  ...
  public static class Builder {
     ...
     * The standard metaobject template associated with the definition.
     */
    public Builder standardTemplate(StandardMetaobjectDefinitionTemplate standardTemplate) {
      this.standardTemplate = standardTemplate;
      return this;
    }
