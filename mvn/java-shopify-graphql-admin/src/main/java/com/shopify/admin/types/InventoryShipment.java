...
public class InventoryShipment implements com.shopify.admin.types.Node {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dateCreated, dateReceived, dateShipped, id, lineItemTotalQuantity, lineItems, lineItemsCount, name, status, totalAcceptedQuantity, totalReceivedQuantity, totalRejectedQuantity, tracking);
  }
