...
public class GiftCardCreditTransaction implements com.shopify.admin.types.GiftCardTransaction, com.shopify.admin.types.HasMetafields, com.shopify.admin.types.Node {
  /**
