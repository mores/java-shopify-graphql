...
public class AbandonedCheckoutsGraphQLQuery extends GraphQLQuery {
  public AbandonedCheckoutsGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, AbandonedCheckoutSortKeys sortKey, String query, String savedSearchId,
  ...
  public AbandonedCheckoutsGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    private AbandonedCheckoutSortKeys sortKey;
    ...
    public AbandonedCheckoutsGraphQLQuery build() {
      return new AbandonedCheckoutsGraphQLQuery(first, after, last, before, reverse, sortKey, query, savedSearchId, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(AbandonedCheckoutSortKeys sortKey) {
