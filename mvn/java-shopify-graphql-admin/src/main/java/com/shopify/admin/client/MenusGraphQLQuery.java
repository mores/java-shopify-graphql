...
public class MenusGraphQLQuery extends GraphQLQuery {
  public MenusGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, MenuSortKeys sortKey, String query, String queryName,
  ...
  public static class Builder {
    ...
    private MenuSortKeys sortKey;

    private String query;

    private String queryName;

    public MenusGraphQLQuery build() {
      return new MenusGraphQLQuery(first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(MenuSortKeys sortKey) {
