...
public class DiscountAutomaticBasicInput {
  ...
  public String toString() {
    return "DiscountAutomaticBasicInput{combinesWith='" + combinesWith + "', title='" + title + "', startsAt='" + startsAt + "', endsAt='" + endsAt + "', context='" + context + "', tags='" + tags + "', minimumRequirement='" + minimumRequirement + "', customerGets='" + customerGets + "', recurringCycleLimit='" + recurringCycleLimit + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(combinesWith, title, startsAt, endsAt, context, tags, minimumRequirement, customerGets, recurringCycleLimit);
  }
