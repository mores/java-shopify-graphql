...
public class CalculatedAutomaticDiscountApplication implements com.shopify.admin.types.CalculatedDiscountApplication {
  /**
  ...
  public String toString() {
    return "CalculatedAutomaticDiscountApplication{allocationMethod='" + allocationMethod + "', appliedTo='" + appliedTo + "', description='" + description + "', id='" + id + "', targetSelection='" + targetSelection + "', targetType='" + targetType + "', value='" + value + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CalculatedAutomaticDiscountApplication that = (CalculatedAutomaticDiscountApplication) o;
  ...
  public static class Builder {
    ...
    public CalculatedAutomaticDiscountApplication build() {
      CalculatedAutomaticDiscountApplication result = new CalculatedAutomaticDiscountApplication();
