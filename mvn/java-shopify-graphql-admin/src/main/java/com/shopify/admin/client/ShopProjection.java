...
public class ShopProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public EntitlementsTypeProjection<ShopProjection<PARENT, ROOT>, ROOT> entitlements() {
     EntitlementsTypeProjection<ShopProjection<PARENT, ROOT>, ROOT> projection = new EntitlementsTypeProjection<>(this, getRoot());
  ...
  public ShopAddressProjection<ShopProjection<PARENT, ROOT>, ROOT> shopAddress() {
     ShopAddressProjection<ShopProjection<PARENT, ROOT>, ROOT> projection = new ShopAddressProjection<>(this, getRoot());
