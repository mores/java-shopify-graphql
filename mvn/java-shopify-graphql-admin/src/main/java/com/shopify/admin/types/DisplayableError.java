...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = CashDrawerCreateUserError.class, name = "CashDrawerCreateUserError"),
    @JsonSubTypes.Type(value = CashDrawerFindOrCreateUserError.class, name = "CashDrawerFindOrCreateUserError"),
    @JsonSubTypes.Type(value = CashDrawerUpdateUserError.class, name = "CashDrawerUpdateUserError"),
    @JsonSubTypes.Type(value = CashManagementReasonCodeCreateUserError.class, name = "CashManagementReasonCodeCreateUserError"),
    @JsonSubTypes.Type(value = CashManagementReasonCodeDeleteUserError.class, name = "CashManagementReasonCodeDeleteUserError"),
    @JsonSubTypes.Type(value = CatalogUserError.class, name = "CatalogUserError"),
    @JsonSubTypes.Type(value = ChannelCreateUserError.class, name = "ChannelCreateUserError"),
    @JsonSubTypes.Type(value = ChannelDeleteUserError.class, name = "ChannelDeleteUserError"),
    @JsonSubTypes.Type(value = ChannelFullSyncUserError.class, name = "ChannelFullSyncUserError"),
    @JsonSubTypes.Type(value = ChannelUpdateUserError.class, name = "ChannelUpdateUserError"),
    @JsonSubTypes.Type(value = CheckoutAndAccountsConfigurationUserError.class, name = "CheckoutAndAccountsConfigurationUserError"),
    ...
    @JsonSubTypes.Type(value = CollectionReorderProductsUserError.class, name = "CollectionReorderProductsUserError"),
    ...
    @JsonSubTypes.Type(value = ConsentPolicyError.class, name = "ConsentPolicyError"),
    ...
    @JsonSubTypes.Type(value = CustomerSetUserError.class, name = "CustomerSetUserError"),
    ...
    @JsonSubTypes.Type(value = FulfillmentOrderCancelError.class, name = "FulfillmentOrderCancelError"),
    ...
    @JsonSubTypes.Type(value = FulfillmentOrderMoveFulfillmentOrderMoveUserError.class, name = "FulfillmentOrderMoveFulfillmentOrderMoveUserError"),
    @JsonSubTypes.Type(value = FulfillmentOrderReleaseHoldUserError.class, name = "FulfillmentOrderReleaseHoldUserError"),
    @JsonSubTypes.Type(value = FulfillmentOrderReportProgressUserError.class, name = "FulfillmentOrderReportProgressUserError"),
    ...
    @JsonSubTypes.Type(value = InventoryShipmentAddItemsUserError.class, name = "InventoryShipmentAddItemsUserError"),
    @JsonSubTypes.Type(value = InventoryShipmentCreateInTransitUserError.class, name = "InventoryShipmentCreateInTransitUserError"),
    @JsonSubTypes.Type(value = InventoryShipmentCreateUserError.class, name = "InventoryShipmentCreateUserError"),
    @JsonSubTypes.Type(value = InventoryShipmentDeleteUserError.class, name = "InventoryShipmentDeleteUserError"),
    @JsonSubTypes.Type(value = InventoryShipmentMarkInTransitUserError.class, name = "InventoryShipmentMarkInTransitUserError"),
    ...
    @JsonSubTypes.Type(value = InventoryShipmentSetBarcodeUserError.class, name = "InventoryShipmentSetBarcodeUserError"),
    ...
    @JsonSubTypes.Type(value = InventoryTransferCancelUserError.class, name = "InventoryTransferCancelUserError"),
    @JsonSubTypes.Type(value = InventoryTransferCreateAsReadyToShipUserError.class, name = "InventoryTransferCreateAsReadyToShipUserError"),
    @JsonSubTypes.Type(value = InventoryTransferCreateUserError.class, name = "InventoryTransferCreateUserError"),
    @JsonSubTypes.Type(value = InventoryTransferDeleteUserError.class, name = "InventoryTransferDeleteUserError"),
    @JsonSubTypes.Type(value = InventoryTransferDuplicateUserError.class, name = "InventoryTransferDuplicateUserError"),
    @JsonSubTypes.Type(value = InventoryTransferEditUserError.class, name = "InventoryTransferEditUserError"),
    @JsonSubTypes.Type(value = InventoryTransferMarkAsReadyToShipUserError.class, name = "InventoryTransferMarkAsReadyToShipUserError"),
    @JsonSubTypes.Type(value = InventoryTransferRemoveItemsUserError.class, name = "InventoryTransferRemoveItemsUserError"),
    @JsonSubTypes.Type(value = InventoryTransferSetItemsUserError.class, name = "InventoryTransferSetItemsUserError"),
    ...
    @JsonSubTypes.Type(value = OrderCreateManualPaymentOrderCreateManualPaymentError.class, name = "OrderCreateManualPaymentOrderCreateManualPaymentError"),
    @JsonSubTypes.Type(value = OrderCreateUserError.class, name = "OrderCreateUserError"),
    @JsonSubTypes.Type(value = OrderCustomerRemoveUserError.class, name = "OrderCustomerRemoveUserError"),
    @JsonSubTypes.Type(value = OrderCustomerSetUserError.class, name = "OrderCustomerSetUserError"),
    ...
    @JsonSubTypes.Type(value = PointOfSaleDeviceAssignToCashDrawerUserError.class, name = "PointOfSaleDeviceAssignToCashDrawerUserError"),
    @JsonSubTypes.Type(value = PointOfSaleDevicePaymentSessionCloseUserError.class, name = "PointOfSaleDevicePaymentSessionCloseUserError"),
    @JsonSubTypes.Type(value = PointOfSaleDevicePaymentSessionCountUserError.class, name = "PointOfSaleDevicePaymentSessionCountUserError"),
    @JsonSubTypes.Type(value = PointOfSaleDevicePaymentSessionOpenUserError.class, name = "PointOfSaleDevicePaymentSessionOpenUserError"),
    ...
    @JsonSubTypes.Type(value = PrivacyFeaturesDisableUserError.class, name = "PrivacyFeaturesDisableUserError"),
    ...
    @JsonSubTypes.Type(value = ShopifyPaymentsPayoutAlternateCurrencyCreateUserError.class, name = "ShopifyPaymentsPayoutAlternateCurrencyCreateUserError"),
    ...
    @JsonSubTypes.Type(value = TaxSummaryCreateUserError.class, name = "TaxSummaryCreateUserError"),
    ...
    @JsonSubTypes.Type(value = ThemeDuplicateUserError.class, name = "ThemeDuplicateUserError"),
