 ...
 */
public class DraftOrdersGraphQLQuery extends GraphQLQuery {
  public DraftOrdersGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, DraftOrderSortKeys sortKey, String query, String savedSearchId,
  ...
  public DraftOrdersGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    private DraftOrderSortKeys sortKey;
    ...
    public DraftOrdersGraphQLQuery build() {
      return new DraftOrdersGraphQLQuery(first, after, last, before, reverse, sortKey, query, savedSearchId, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(DraftOrderSortKeys sortKey) {
