...
public class CompanyLocationProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public CompanyLocationTaxSettingsProjection<CompanyLocationProjection<PARENT, ROOT>, ROOT> taxSettings(
      ) {
     CompanyLocationTaxSettingsProjection<CompanyLocationProjection<PARENT, ROOT>, ROOT> projection = new CompanyLocationTaxSettingsProjection<>(this, getRoot());
