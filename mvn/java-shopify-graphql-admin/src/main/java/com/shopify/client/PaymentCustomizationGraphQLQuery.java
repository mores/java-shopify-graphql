...
public class PaymentCustomizationGraphQLQuery extends GraphQLQuery {
  ...
  public PaymentCustomizationGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    public PaymentCustomizationGraphQLQuery build() {
      return new PaymentCustomizationGraphQLQuery(id, queryName, fieldsSet);
