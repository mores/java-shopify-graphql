...
public class SellingPlanGroupsGraphQLQuery extends GraphQLQuery {
  public SellingPlanGroupsGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, SellingPlanGroupSortKeys sortKey, String query, String queryName,
  ...
  public SellingPlanGroupsGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    private SellingPlanGroupSortKeys sortKey;

    private String query;

    private String queryName;

    public SellingPlanGroupsGraphQLQuery build() {
      return new SellingPlanGroupsGraphQLQuery(first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(SellingPlanGroupSortKeys sortKey) {
