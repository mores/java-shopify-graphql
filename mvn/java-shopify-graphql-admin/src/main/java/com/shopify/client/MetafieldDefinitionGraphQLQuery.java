...
public class MetafieldDefinitionGraphQLQuery extends GraphQLQuery {
  public MetafieldDefinitionGraphQLQuery(String id, String queryName, Set<String> fieldsSet) {
  ...
  public static class Builder {
    ...
    public MetafieldDefinitionGraphQLQuery build() {
      return new MetafieldDefinitionGraphQLQuery(id, queryName, fieldsSet);
