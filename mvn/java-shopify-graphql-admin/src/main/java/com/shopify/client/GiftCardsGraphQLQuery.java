...
public class GiftCardsGraphQLQuery extends GraphQLQuery {
  public GiftCardsGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, GiftCardSortKeys sortKey, String query, String savedSearchId,
  ...
  public static class Builder {
    ...
    private GiftCardSortKeys sortKey;
    ...
    public GiftCardsGraphQLQuery build() {
      return new GiftCardsGraphQLQuery(first, after, last, before, reverse, sortKey, query, savedSearchId, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(GiftCardSortKeys sortKey) {
