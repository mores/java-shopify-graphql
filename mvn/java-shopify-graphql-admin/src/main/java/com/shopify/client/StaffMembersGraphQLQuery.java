...
public class StaffMembersGraphQLQuery extends GraphQLQuery {
  ...
  public StaffMembersGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    private StaffMembersSortKeys sortKey;

    private String query;

    private String queryName;

    public StaffMembersGraphQLQuery build() {
      return new StaffMembersGraphQLQuery(first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
