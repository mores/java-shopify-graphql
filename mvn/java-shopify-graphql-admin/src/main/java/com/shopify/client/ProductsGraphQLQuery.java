...
public class ProductsGraphQLQuery extends GraphQLQuery {
  public ProductsGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, ProductSortKeys sortKey, String query, String savedSearchId,
  ...
  public static class Builder {
    ...
    public ProductsGraphQLQuery build() {
      return new ProductsGraphQLQuery(first, after, last, before, reverse, sortKey, query, savedSearchId, queryName, fieldsSet);
