...
public class CarrierServicesGraphQLQuery extends GraphQLQuery {
  public CarrierServicesGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, CarrierServiceSortKeys sortKey, String query, String queryName,
  ...
  public CarrierServicesGraphQLQuery() {
    super("query");
  }
  ...
  public static class Builder {
    ...
    private CarrierServiceSortKeys sortKey;

    private String query;

    private String queryName;

    public CarrierServicesGraphQLQuery build() {
      return new CarrierServicesGraphQLQuery(first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
     ...
     */
    public Builder sortKey(CarrierServiceSortKeys sortKey) {
