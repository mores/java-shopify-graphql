...
public class MediaProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public MediaPresentationProjection<MediaProjection<PARENT, ROOT>, ROOT> presentation() {
     MediaPresentationProjection<MediaProjection<PARENT, ROOT>, ROOT> projection = new MediaPresentationProjection<>(this, getRoot());
     getFields().put("presentation", projection);
     return projection;
  }

  public ImageProjection<MediaProjection<PARENT, ROOT>, ROOT> previewImage() {
     ImageProjection<MediaProjection<PARENT, ROOT>, ROOT> projection = new ImageProjection<>(this, getRoot());
