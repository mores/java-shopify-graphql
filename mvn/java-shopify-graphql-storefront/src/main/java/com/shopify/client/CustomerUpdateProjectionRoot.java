...
public class CustomerUpdateProjectionRoot<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public CustomerAccessTokenProjection<CustomerUpdateProjectionRoot<PARENT, ROOT>, CustomerUpdateProjectionRoot<PARENT, ROOT>> customerAccessToken(
      ) {
    CustomerAccessTokenProjection<CustomerUpdateProjectionRoot<PARENT, ROOT>, CustomerUpdateProjectionRoot<PARENT, ROOT>> projection = new CustomerAccessTokenProjection<>(this, this);    
    getFields().put("customerAccessToken", projection);
    return projection;
  }

  public CustomerUserErrorProjection<CustomerUpdateProjectionRoot<PARENT, ROOT>, CustomerUpdateProjectionRoot<PARENT, ROOT>> customerUserErrors(
      ) {
    CustomerUserErrorProjection<CustomerUpdateProjectionRoot<PARENT, ROOT>, CustomerUpdateProjectionRoot<PARENT, ROOT>> projection = new CustomerUserErrorProjection<>(this, this);    
