...
public class ProductsProjectionRoot<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public FilterProjection<ProductsProjectionRoot<PARENT, ROOT>, ProductsProjectionRoot<PARENT, ROOT>> filters(
      ) {
    FilterProjection<ProductsProjectionRoot<PARENT, ROOT>, ProductsProjectionRoot<PARENT, ROOT>> projection = new FilterProjection<>(this, this);    
