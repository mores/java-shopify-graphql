...
public class MenuItemProjection<PARENT extends BaseSubProjectionNode<?, ?>, ROOT extends BaseSubProjectionNode<?, ?>> extends BaseSubProjectionNode<PARENT, ROOT> {
  ...
  public MenuItemResourceProjection<MenuItemProjection<PARENT, ROOT>, ROOT> resource() {
     MenuItemResourceProjection<MenuItemProjection<PARENT, ROOT>, ROOT> projection = new MenuItemResourceProjection<>(this, getRoot());
