 ...
 * or [`Order`](https://shopify.dev/docs/api/storefront/current/objects/Order).
 ...
 *
 * The address includes geographic coordinates and provides pre-formatted output through the [`formatted`](https://shopify.dev/docs/api/storefront/current/objects/MailingAddress#field-MailingAddress.fields.formatted)
 * field, which can optionally include or exclude name and company details.
 */
@JsonTypeInfo(
    use = JsonTypeInfo.Id.NONE
)
public class MailingAddress implements DeliveryAddress, com.shopify.storefront.types.Node {
  /**
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address1, address2, city, company, country, countryCode, countryCodeV2, firstName, formatted, formattedArea, id, lastName, latitude, longitude, name, phone, province, provinceCode, zip);
  }
