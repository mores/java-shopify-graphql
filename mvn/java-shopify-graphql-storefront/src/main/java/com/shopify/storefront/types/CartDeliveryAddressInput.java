 ...
 */
public class CartDeliveryAddressInput {
  /**
  ...
  public CartDeliveryAddressInput() {
  }
  ...
  public boolean equals(Object o) {
    ...
    CartDeliveryAddressInput that = (CartDeliveryAddressInput) o;
  ...
  public static class Builder {
    ...
    public CartDeliveryAddressInput build() {
      CartDeliveryAddressInput result = new CartDeliveryAddressInput();
