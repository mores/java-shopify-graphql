...
public class CartDiscountCodesUpdatePayload {
  ...
  public String toString() {
    return "CartDiscountCodesUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartDiscountCodesUpdatePayload that = (CartDiscountCodesUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartDiscountCodesUpdatePayload build() {
      CartDiscountCodesUpdatePayload result = new CartDiscountCodesUpdatePayload();
