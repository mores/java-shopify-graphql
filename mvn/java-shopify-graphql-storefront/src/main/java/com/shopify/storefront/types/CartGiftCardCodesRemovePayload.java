 ...
 */
public class CartGiftCardCodesRemovePayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartGiftCardCodesRemovePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartGiftCardCodesRemovePayload that = (CartGiftCardCodesRemovePayload) o;
  ...
  public static class Builder {
    ...
    public CartGiftCardCodesRemovePayload build() {
      CartGiftCardCodesRemovePayload result = new CartGiftCardCodesRemovePayload();
