 ...
 */
public class CartGiftCardCodesAddPayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartGiftCardCodesAddPayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartGiftCardCodesAddPayload that = (CartGiftCardCodesAddPayload) o;
  ...
  public static class Builder {
    ...
    public CartGiftCardCodesAddPayload build() {
      CartGiftCardCodesAddPayload result = new CartGiftCardCodesAddPayload();
