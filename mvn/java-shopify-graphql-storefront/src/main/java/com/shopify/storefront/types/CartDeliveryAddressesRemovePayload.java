 ...
 */
public class CartDeliveryAddressesRemovePayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartDeliveryAddressesRemovePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartDeliveryAddressesRemovePayload that = (CartDeliveryAddressesRemovePayload) o;
  ...
  public static class Builder {
    ...
    public CartDeliveryAddressesRemovePayload build() {
      CartDeliveryAddressesRemovePayload result = new CartDeliveryAddressesRemovePayload();
