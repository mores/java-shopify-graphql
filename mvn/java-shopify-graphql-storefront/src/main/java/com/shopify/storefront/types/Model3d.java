...
public class Model3d implements MetafieldReference, com.shopify.storefront.types.Media, com.shopify.storefront.types.Node {
  /**
  ...
  public String toString() {
    return "Model3d{alt='" + alt + "', id='" + id + "', mediaContentType='" + mediaContentType + "', presentation='" + presentation + "', previewImage='" + previewImage + "', sources='" + sources + "'}";
  }
