...
public class ProductVariant implements Merchandise, MetafieldParentResource, MetafieldReference, com.shopify.storefront.types.HasMetafields, com.shopify.storefront.types.Node {
  /**
