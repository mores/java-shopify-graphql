 ...
 * contact details, or store policies.
 *
 * Each page has a unique [`handle`](https://shopify.dev/docs/api/storefront/current/objects/Page#field-Page.fields.handle)
 * for URL routing and includes
 * [`SEO`](https://shopify.dev/docs/api/storefront/current/objects/SEO) information
 * for search engine optimization. Pages support
...
public class Page implements MenuItemResource, MetafieldParentResource, MetafieldReference, SearchResultItem, com.shopify.storefront.types.HasMetafields, com.shopify.storefront.types.Node, com.shopify.storefront.types.OnlineStorePublishable, com.shopify.storefront.types.Trackable {
  /**
