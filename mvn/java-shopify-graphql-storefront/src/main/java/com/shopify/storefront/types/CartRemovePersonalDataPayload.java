 ...
 */
public class CartRemovePersonalDataPayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartRemovePersonalDataPayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartRemovePersonalDataPayload that = (CartRemovePersonalDataPayload) o;
  ...
  public static class Builder {
    ...
    public CartRemovePersonalDataPayload build() {
      CartRemovePersonalDataPayload result = new CartRemovePersonalDataPayload();
