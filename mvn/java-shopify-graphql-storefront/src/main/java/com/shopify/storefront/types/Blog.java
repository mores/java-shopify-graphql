...
public class Blog implements MenuItemResource, MetafieldParentResource, com.shopify.storefront.types.HasMetafields, com.shopify.storefront.types.Node, com.shopify.storefront.types.OnlineStorePublishable {
  /**
