...
public class CartCreatePayload {
  ...
  public String toString() {
    return "CartCreatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartCreatePayload that = (CartCreatePayload) o;
  ...
  public static class Builder {
    ...
    public CartCreatePayload build() {
      CartCreatePayload result = new CartCreatePayload();
