 ...
 */
public class CartDeliveryAddressesReplacePayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartDeliveryAddressesReplacePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartDeliveryAddressesReplacePayload that = (CartDeliveryAddressesReplacePayload) o;
  ...
  public static class Builder {
    ...
    public CartDeliveryAddressesReplacePayload build() {
      CartDeliveryAddressesReplacePayload result = new CartDeliveryAddressesReplacePayload();
