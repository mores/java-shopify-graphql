...
public class CartClonePayload {
  ...
  public String toString() {
    return "CartClonePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartClonePayload that = (CartClonePayload) o;
  ...
  public static class Builder {
    ...
    public CartClonePayload build() {
      CartClonePayload result = new CartClonePayload();
