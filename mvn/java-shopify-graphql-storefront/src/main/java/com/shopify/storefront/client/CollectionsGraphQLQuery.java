...
import com.shopify.storefront.types.CollectionSortKeys;
...
public class CollectionsGraphQLQuery extends GraphQLQuery {
  public CollectionsGraphQLQuery(String after, String before, Integer first, Integer last,
      String query, Boolean reverse, CollectionSortKeys sortKey, String queryName,
  ...
  public static class Builder {
    ...
    public CollectionsGraphQLQuery build() {
      return new CollectionsGraphQLQuery(after, before, first, last, query, reverse, sortKey, queryName, fieldsSet);
