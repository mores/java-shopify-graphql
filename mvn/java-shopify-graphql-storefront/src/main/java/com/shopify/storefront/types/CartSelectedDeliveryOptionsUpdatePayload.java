...
public class CartSelectedDeliveryOptionsUpdatePayload {
  ...
  public String toString() {
    return "CartSelectedDeliveryOptionsUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartSelectedDeliveryOptionsUpdatePayload that = (CartSelectedDeliveryOptionsUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartSelectedDeliveryOptionsUpdatePayload build() {
      CartSelectedDeliveryOptionsUpdatePayload result = new CartSelectedDeliveryOptionsUpdatePayload();
