...
public class CartNoteUpdatePayload {
  ...
  public String toString() {
    return "CartNoteUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartNoteUpdatePayload that = (CartNoteUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartNoteUpdatePayload build() {
      CartNoteUpdatePayload result = new CartNoteUpdatePayload();
