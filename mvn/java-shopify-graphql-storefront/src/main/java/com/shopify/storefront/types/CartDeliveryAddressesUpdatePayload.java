 ...
 */
public class CartDeliveryAddressesUpdatePayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartDeliveryAddressesUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartDeliveryAddressesUpdatePayload that = (CartDeliveryAddressesUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartDeliveryAddressesUpdatePayload build() {
      CartDeliveryAddressesUpdatePayload result = new CartDeliveryAddressesUpdatePayload();
