 ...
 */
public class CartDeliveryAddressesAddPayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartDeliveryAddressesAddPayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartDeliveryAddressesAddPayload that = (CartDeliveryAddressesAddPayload) o;
  ...
  public static class Builder {
    ...
    public CartDeliveryAddressesAddPayload build() {
      CartDeliveryAddressesAddPayload result = new CartDeliveryAddressesAddPayload();
