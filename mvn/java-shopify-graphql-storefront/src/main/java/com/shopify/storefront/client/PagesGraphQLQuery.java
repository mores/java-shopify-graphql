...
public class PagesGraphQLQuery extends GraphQLQuery {
  public PagesGraphQLQuery(Integer first, String after, Integer last, String before,
      Boolean reverse, PageSortKeys sortKey, String query, String queryName,
  ...
  public static class Builder {
    ...
    public PagesGraphQLQuery build() {
      return new PagesGraphQLQuery(first, after, last, before, reverse, sortKey, query, queryName, fieldsSet);
