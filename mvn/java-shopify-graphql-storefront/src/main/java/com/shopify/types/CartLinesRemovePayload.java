...
public class CartLinesRemovePayload {
  ...
  public String toString() {
    return "CartLinesRemovePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartLinesRemovePayload that = (CartLinesRemovePayload) o;
  ...
  public static class Builder {
    ...
    public CartLinesRemovePayload build() {
      CartLinesRemovePayload result = new CartLinesRemovePayload();
