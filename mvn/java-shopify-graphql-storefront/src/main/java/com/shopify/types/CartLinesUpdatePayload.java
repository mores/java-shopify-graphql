...
public class CartLinesUpdatePayload {
  ...
  public String toString() {
    return "CartLinesUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartLinesUpdatePayload that = (CartLinesUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartLinesUpdatePayload build() {
      CartLinesUpdatePayload result = new CartLinesUpdatePayload();
