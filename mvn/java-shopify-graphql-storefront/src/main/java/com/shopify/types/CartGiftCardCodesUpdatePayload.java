 ...
 */
public class CartGiftCardCodesUpdatePayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartGiftCardCodesUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartGiftCardCodesUpdatePayload that = (CartGiftCardCodesUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartGiftCardCodesUpdatePayload build() {
      CartGiftCardCodesUpdatePayload result = new CartGiftCardCodesUpdatePayload();
