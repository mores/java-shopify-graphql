 ...
 */
public class CartBillingAddressUpdatePayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartBillingAddressUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartBillingAddressUpdatePayload that = (CartBillingAddressUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartBillingAddressUpdatePayload build() {
      CartBillingAddressUpdatePayload result = new CartBillingAddressUpdatePayload();
