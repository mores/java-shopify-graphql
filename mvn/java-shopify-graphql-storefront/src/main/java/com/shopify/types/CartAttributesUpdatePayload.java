...
public class CartAttributesUpdatePayload {
  ...
  public String toString() {
    return "CartAttributesUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartAttributesUpdatePayload that = (CartAttributesUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartAttributesUpdatePayload build() {
      CartAttributesUpdatePayload result = new CartAttributesUpdatePayload();
