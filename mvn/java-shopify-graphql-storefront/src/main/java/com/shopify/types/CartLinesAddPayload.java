...
public class CartLinesAddPayload {
  ...
  public String toString() {
    return "CartLinesAddPayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartLinesAddPayload that = (CartLinesAddPayload) o;
  ...
  public static class Builder {
    ...
    public CartLinesAddPayload build() {
      CartLinesAddPayload result = new CartLinesAddPayload();
