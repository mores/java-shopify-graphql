 ...
 */
public class CartPaymentUpdatePayload {
  /**
   * The updated cart.
   */
  private Cart cart;
  ...
  public String toString() {
    return "CartPaymentUpdatePayload{cart='" + cart + "', userErrors='" + userErrors + "', warnings='" + warnings + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CartPaymentUpdatePayload that = (CartPaymentUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public CartPaymentUpdatePayload build() {
      CartPaymentUpdatePayload result = new CartPaymentUpdatePayload();
